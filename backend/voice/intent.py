...
INTENTS = {
    'describe': [
        'describe', 'what is', "what's", 'around me', 'in front',
        'what do you see', 'look', 'scene', 'surroundings', 'where am i'
    ],
    'read': [
    ...
    'detect': [
        'detect', 'objects', 'what objects', 'scan'
    ],
    'stop': [
...
def parse_intent(text):
    """
    Parse voice command text and return intent + parameters.
    Returns dict: { intent, object (if find), confidence }
    """
    if not text:
...
def get_help_text():
    return (
        ...
        "Say detect to identify all objects in the scene. "
